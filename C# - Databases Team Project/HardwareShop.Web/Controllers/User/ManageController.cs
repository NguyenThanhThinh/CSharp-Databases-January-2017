namespace HardwareShop.Web.Controllers.User
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IManageService manageService)
        {
        ...
        public ActionResult Manage()
        {
            ...
            var model = this.manageService.GetUser(userId);
        ...
        public ActionResult Manage(ManageUserViewModel model)
        {
            ...
            this.manageService.EditUser(model);
