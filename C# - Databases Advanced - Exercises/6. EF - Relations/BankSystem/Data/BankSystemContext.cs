namespace BankSystem.Data
{
    ...
    public class BankSystemContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            // Set unique.
            modelBuilder.Entity<SavingAccount>().Property(a => a.AccountNumber)
                .HasColumnAnnotation("IX_SavingAccounts_Username", new IndexAnnotation(new IndexAttribute { IsUnique = true }));
            ...
            modelBuilder.Entity<User>().Property(u => u.Username)
                .HasColumnAnnotation("IX_Users_Username", new IndexAnnotation(new IndexAttribute { IsUnique = true }));
            modelBuilder.Entity<User>().Property(u => u.Email)
                .HasColumnAnnotation("IX_Users_Email", new IndexAnnotation(new IndexAttribute { IsUnique = true }));
