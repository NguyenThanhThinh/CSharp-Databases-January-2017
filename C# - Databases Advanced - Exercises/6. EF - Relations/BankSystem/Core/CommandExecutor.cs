namespace BankSystem.Core
{
    ...
    public class CommandExecutor
    {
        ...
        private string DeductFee(string[] input)
        {
            ...
            return $"Account {accountNumber} - fee deducted ${currentBalance}";
        }
        ...
        private string AddInterest(string[] input)
        {
            ...
            return $"Account {accountNumber} - interest added ${currentBalance}";
        }
        ...
        private void ValidateUser(User user)
        {
            ...
            if (user == null)
            {
                ...
                // If user is null there is no way we can set it's username or password
                // (they simply don't set) so we return directly our result.
