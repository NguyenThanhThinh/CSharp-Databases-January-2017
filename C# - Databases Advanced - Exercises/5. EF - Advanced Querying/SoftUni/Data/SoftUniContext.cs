namespace SoftUni.Data
{
    ...
    public partial class SoftUniContext : DbContext
    {
        ...
        public IEnumerable<ProjectInfo> FindAllProjectsForGivenEmployee(string firstName, string lastName)
        {
            ...
            return this.Database.SqlQuery<ProjectInfo>("FindAllProjectsForGivenEmployee @FirstName, @LastName", firstNameParam, lastNameParam);
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>()
                ...
                .WithMany(e => e.Employees)
                    .Map(m => m.ToTable("EmployeesProjects")
